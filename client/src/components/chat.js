...
//   useEffect(() => {
//     // Create a Socket.IO connection to the server with the token
//     console.log("Token used for connection:", Token);
//     const socketInstance = io("http://localhost:5000", {
//       auth: {
//         token: Token, // Send token with the connection request
//       },
//     });
...
//     socketInstance.on("received query", (data) => {
//       setMessages((prevMessages) => [
//         ...prevMessages,
//         { text: `${data.user}: ${data.text}`, isUser: false },
//       ]);
//     });
