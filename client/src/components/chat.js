...
//   const [isUserOnline, setIsUserOnline] = useState(false); // New state for user status
...
//       console.log(
//         `User ${data.userId} is ${data.isStatus ? "online" : "offline"}`
//       );
//       if (data.userId === socketInstance.id) {
//         setIsUserOnline(data.isStatus); // Update online status
//       }
//     });
...
//           Chatbot ({userName}) {isUserOnline ? "online" : "offline"}
//         </Card.Header>
